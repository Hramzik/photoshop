...
const double Window_Frame::DEFAULT_CLOSE_BUTTON_WIDTH = 30;
        ...
        top_frame_       (nullptr)
{
    ...
    plug::Vec2d top_frame_position (0, 0);
    ...
    plug::Vec2d close_button_position (0, 0);
    close_button_position.x += top_frame_width - DEFAULT_CLOSE_BUTTON_WIDTH;
